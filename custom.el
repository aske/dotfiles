(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (window-numbering yasnippet use-package slim-mode python-mode projectile powerline-evil nix-sandbox nav magit linum-relative key-chord flycheck-pos-tip flycheck-haskell company-quickhelp company-nixos-options company-jedi ace-jump-mode)))
